...
db.transaction(function(tx) {
  ...
  tx.executeSql('CREATE TABLE IF NOT EXISTS framegrabs (dataUrl, pageTitle, pageUrl, timecode FLOAT(2), videoSrc, UNIQUE(pageUrl, videoSrc, timecode))', [], null, queryErrorHandler);
