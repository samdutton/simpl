...
function displayOnlineStatus() {
  if (navigator.onLine) {
    onlineBanner.className = 'online';
    onlineBanner.textContent = 'I\'m online :^)';
  } else {
    onlineBanner.className = 'offline';
    onlineBanner.textContent = 'I\'m offline :^)';
  }
}
displayOnlineStatus();

window.ononline = window.onoffline = displayOnlineStatus;
